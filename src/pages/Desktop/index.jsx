...
export default function DesktopPage() {
  return (
    <>
      <Helmet>
        <title>Rajat's Application3</title>
        <meta name="description" content="Web site created using create-react-app" />
      </Helmet>
      <div className="w-full bg-black-900_01 pb-[15px]">
        <div className="flex flex-col items-center">
          <header className="flex items-center justify-center self-stretch bg-gradient p-[11px] shadow-xs">
            ...
            <div>
              <div className="relative h-[1505px] self-end">
                <div className="absolute bottom-0 left-0 right-0 top-0 m-auto h-max w-full">
                  <div className="h-[730px] border border-solid border-black-900_01 bg-gradient1" />
                  <Img
                ...
                <div className="absolute left-0 right-0 top-[4%] m-auto flex w-full max-w-[947px] items-start md:relative md:flex-col md:p-5">
                  <div className="flex flex-1 items-center md:flex-col md:self-stretch">
                    ...
                    <div className="relative ml-[-58px] flex flex-1 flex-col items-center gap-8 md:ml-0 md:self-stretch">
                      ...
                      <Heading
                        size="md"
                        as="h1"
                        className="text-shadow-ts text-center leading-[125px] tracking-[-12.38px]"
                      >
                        <>
                          One Task
                          <br />
                  ...
                  <Img
                    ...
                    alt="messagetwo_one"
                    className="relative z-[1] ml-[-38px] mt-[115px] h-[200px] w-[200px] object-cover md:ml-0 md:w-full"
                  />
                </div>
                <Img
                  src="images/img_message_1.png"
                  alt="messageone_one"
                  className="absolute right-[10%] top-[11%] m-auto h-[200px] w-[200px] object-cover"
                />
              </div>
            </div>
          </div>
          <div className="flex justify-center self-stretch p-5">
            <div className="mb-[23px] flex w-[88%] flex-col items-center gap-9 md:w-full">
              ...
              <div className="flex items-center justify-between gap-5 self-stretch md:flex-col">
                ...
                />
                <Img src="images/img_apex_1.png" alt="apexone_one" className="h-[27px] w-[8%] object-cover md:w-full" />
              </div>
            </div>
          </div>
